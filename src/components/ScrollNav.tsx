...
const sections: Section[] = [
  ...
  { id: 'ch-06', label: '6. Building the Thirteen Algorithms (General)', short: 'Ch 6' },
  { id: 'ch-07', label: '7. Building the Thirteen Algorithms (Scientific)', short: 'Ch 7' },
  { id: 'ch-08', label: '8. Beyond Cancer', short: 'Ch 8' },
  { id: 'ch-09', label: '9. From Flag to Finding', short: 'Ch 9' },
  { id: 'ch-10', label: '10. The Consortium Model', short: 'Ch 10' },
  { id: 'ch-11', label: '11. The Economics', short: 'Ch 11' },
  { id: 'ch-12', label: '12. The Equity Imperative', short: 'Ch 12' },
  { id: 'ch-13', label: '13. Conquer Cancer', short: 'Ch 13' },
  { id: 'ch-14', label: '14. The Last Mile', short: 'Ch 14' },
